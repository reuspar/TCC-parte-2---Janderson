...
\par
Observando os testes realizados para a base de dados com 4 atributos, de todos os suporte testados, apenas uma regra foi gerada, sendo ela, para o suporte com 15\%. O algoritmo não mostrou muita eficiência para os atributos utilizados por \citeonline{LeandroSilva2014} em relação  aos registros pertencentes a base de dados utilizada neste projeto, entretanto, a regra que foi gerada é semelhante a mesma regra obtida por eles com o mesmo suporte utilizado (15\%), onde, a escolaridade da mãe e a quantidade de pessoas que residem com o candidato, influenciavam para que o candidato possuísse um desempenho regular na prova do ENEM.
...
% O que pode acabar indicando a falta de acessibilidade em relação as escolas ou forma que é aplicada a prova para esse tipo de grupo.