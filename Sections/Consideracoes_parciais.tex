...
\par
\textcolor{red}{Podemos sugerir também, uma análise temporal do desempenho dos candidatos em relação ao vestibular, onde, pegaria a base de dados dos vestibulares anteriores em relação ao ano da base em que está sendo utilizada e identificaria através da mineração, os fatores que mais ocorrer entre esses anos. Analisando assim, o progresso de influência de um determinado fator, o período em que mais ocorreu e quem foi afetado por esses tipos de fatores.}
