...
\par
MILLER OLHAR: \textcolor{red}{De acordo com a análise e os parâmetros utilizados neste trabalho, através das regras geradas pelos algoritmos de classificação e associação, foram obtidos os perfis dos candidatos, com uma taxa de precisão até que boa, em comparação a média entre as duas. Sendo que das informações obtidas, dentre os atributos que formavam as regras, pode-se destacar o atributo que indicava o tipo de deficiência do candidato, onde, teve como maior relevância para as regras obtidas nos dois algoritmos. Demonstrando, que dentre todos os candidatos que foram aprovados, uma quantidade bem pequena representava aqueles que possuíam alguma deficiência, o que pode indicar a falta de acessibilidade no sistema de educação que possuímos hoje.}
